...
const VisitorIsNumber = require("./visitor-is-number");
const VisitorIsString = require("./visitor-is-string");
const VisitorTypeCheck = require("./visitor-type-check");
...
function visitRegularObjectType(type, indexType, visitorContext) {
    ...
    return VisitorUtils.setFunctionIfNotExists(name, visitorContext, () => {
        ...
        if (typeof stringType === 'boolean') {
            ...
            const strings = utils_1.sliceSet(stringType);
...
function visitTupleObjectType(type, indexType, visitorContext) {
    ...
    return VisitorUtils.setFunctionIfNotExists(name, visitorContext, () => {
        ...
        if (typeof numberType === 'boolean') {
            ...
            const numbers = utils_1.sliceSet(numberType);
